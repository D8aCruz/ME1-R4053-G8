...
const float a1 =  1;//0.9933;
const float b1 = 0;//-1.7347;

const float a2 = 1;//0.988;
const float b2 = 0;//-1.5664;

const float a3 = 1;//1.0074;
const float b3 = 0;//-14.753;
